...
public class PersonController {
	...
	@ApiOperation(value = "Encontrar uma pessoa específica pelo nome" ) 
	...
	@ApiOperation(value = "Encontre uma pessoa especifica pelo seu ID" )
	...
	@ApiOperation(value = "Atualizar uma pessoa especifica")
	...
	@ApiOperation(value = "Desabilitar uma pessoa pelo seu ID" )
	...
	@ApiOperation(value = "Exclua uma pessoa especifica pelo seu ID")
	@DeleteMapping("/{id}")
